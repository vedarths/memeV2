//
//  SentMemeColViewController.swift
//  MyVMeme
//
//  Created by Vedarth Solutions on 6/21/18.
...
class SentMemeCollViewController : UIViewController, UICollectionViewDelegate,  UICollectionViewDataSource {
